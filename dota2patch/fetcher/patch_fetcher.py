...
class PatchFetcher():
    ...
    def construct_all_patch_documents(self, patch_version):
        ...
        patch_data = self.fetch_and_parse_json(
            f'https://www.dota2.com/datafeed/patchnotes?version={
                patch_version}&language=english')
        patch_metadata = {
